"""
Builder é um padrão de criação que tem a itenção de separar a construção de
um objeto complexo da sua representação, de modo que o mesmo processo de
construção possa criar diferentes representações.

Builder te da a possibilidade de criar objetos passo-a-passo e isso já
...
class UserDirector:
    ...
    def with_age(self, firstname, lastname, age):
        self._builder.add_firstname(firstname)\
            .add_lastname(lastname).add_age(age)
...
if __name__ == "__main__":
    ...
    user1 = user_director.with_age("João", "Justino", 21)
    print(user1)

    user2 = user_director.with_address("Maikin", "Santos", "Rua X - N°: 321")
    print(user2)
